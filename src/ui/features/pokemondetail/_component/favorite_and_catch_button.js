...
const FavoriteAndCatchButton = ({ onPressFavorite, onPressCatch, isFavorite }) => {
    return (
        <View
            style={{
                flexDirection: 'row',
            ...
            <TouchableScale onPress={() => onPressCatch()} style={{ marginHorizontal: 5 }} activeScale={0.9}>
                <View
                    style={{
                        alignItems: 'center',
                        borderRadius: 10,
            ...
            <TouchableScale onPress={() => onPressFavorite()} style={{ marginHorizontal: 5 }} activeScale={0.9}>
                {
                    isFavorite ?
                        <View
                            style={{
                            ...
                            <Ionicons
                                ...
                                size={20}
                            />
                            <Text style={{ paddingHorizontal: 8, fontWeight: '700', color: themeColors().notification }}>
                                Remove Favorite
                            </Text>
                        </View>
